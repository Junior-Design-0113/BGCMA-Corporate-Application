...
class CommitteeHome extends Component {
  ...
  //Methods to handle navigation from the home page
  meetingFiles() {
      ...
      <View style={styles.container}>
        <View style={styles.form}>
          ...
          <View style={styles.pageButtonHolder}>
            <Button  style={styles.pageButton} onPress={() => this.meetingFiles()}>
              <Text style={styles.text}>Meeting Files</Text>
            </Button>
          </View>

          <View style={styles.pageButtonHolder}>
            <Button  style={styles.pageButton} onPress={() => this.committeePage()}>
              <Text style={styles.text}>Committee Page</Text>
            </Button>
          </View>

          <View style={styles.pageButtonHolder}>
            <Button  style={styles.pageButton} onPress={() => this.calendar()}>
              <Text style={styles.text}>Calendar</Text>
            </Button>
          </View>

          <View style={styles.pageButtonHolder}>
            <Button  style={styles.pageButton} onPress={() => this.members()}>
