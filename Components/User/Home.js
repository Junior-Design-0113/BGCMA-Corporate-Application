    ...
    if (this.state.admin) {
      return (
        <View style={styles.buttonHolder}>
          <Button  style={styles.button2} onPress={() => this.pendingUsers()}>
            <Text style={styles.pendingText}>Pending Users</Text>
          </Button>
        </View>
      )
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.buttonHolder}>
              <Button  style={styles.button} onPress={() => this.profile()}>
                <Text style={styles.text}>Profile</Text>
              </Button>
              <Button  style={styles.button} onPress={() => this.calendar()}>
                <Text style={styles.text}>Calendar</Text>
              </Button>
          </View>
          <View style={styles.buttonHolder}>
              <Button  style={styles.button} onPress={() => this.chat()}>
                <Text style={styles.text}>Chat</Text>
              </Button>
              <Button  style={styles.button} onPress={() => this.pages()}>
